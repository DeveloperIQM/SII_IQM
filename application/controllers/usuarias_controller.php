...
Fecha Creación: 16 Noviembre 2017
Fecha Modificación: 
Proyecto: Sistema de Información Interna IQM
Archivo: Controlador Usuarias IQM
Versión: 1.0
*/
class Usuarias_controller extends CI_Controller
{
	...
	//Funcion que carga la vista para mostrar las usuarias registradas
	public function index(){
		$data = array('titulo' => 'SII IQM - Usuarias IQM');
		$this->load->view("header/head", $data);
		$this->load->view("header/nav");
		$this->load->view("header/head");

		$resultado=$this->usuarias_model->getUsuaria();
		$data2 = array('consulta' => $resultado);
		$this->load->view("body/usuarias_view", $data2);
